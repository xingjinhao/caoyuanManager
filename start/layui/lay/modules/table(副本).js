...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            var r = {};
            // var content = {};
            // content[l.pageName] = e, content[l.limitName] = a.limit;
            r[l.pageName] = e, r[l.limitName] = a.limit;
            // r['content'] = content;
            var x = t.extend(r, a.where);
            var d = {};
            d['content'] = t.extend(r, a.where);
            d['token']=layui.data('data').token;
            d['uid'] = layui.data('data').uid;
