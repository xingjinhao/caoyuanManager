...
! function(e, t) {
	...
	pe.extend({
		...
		ajax: function(t, n) {
			...
			if(g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, d.url = ((t || d.url || en) + "").replace(zt, "").replace(Jt, tn[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = pe.trim(d.dataType || "*").toLowerCase().match(De) || [""], null == d.crossurll && (i = Gt.exec(d.url.toLowerCase()), d.crossurll = !(!i || i[1] === tn[1] && i[2] === tn[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (tn[3] || ("http:" === tn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = pe.param(d.data, d.traditional)), U(Kt, d, n, T), 2 === b) return T;
	...
	e.attachEvent && e.attachEvent("onunload", function() {
		...
		if(!t.crossurll || fe.cors) {
			...
			return {
				send: function(r, i) {
					...
					t.mimeType && a.overrideMimeType && a.overrideMimeType(t.mimeType), t.crossurll || r["X-Requested-With"] || (r["X-Requested-With"] = "XMLHttpRequest");
					...
					a.send(t.hasContent && t.data || null), n = function(e, r) {
						...
						if(n && (r || 4 === a.readyState))
							if(delete ln[s], n = void 0, a.onreadystatechange = pe.noop, r) 4 !== a.readyState && a.abort();
								...
								o || !t.isLocal || t.crossurll ? 1223 === o && (o = 204) : o = l.text ? 200 : 404
							}
		...
		void 0 === e.cache && (e.cache = !1), e.crossurll && (e.type = "GET", e.global = !1)
